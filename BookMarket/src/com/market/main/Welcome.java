...
public class Welcome {
	...
	public static void BookList(Book[]booklist) {
		...
		booklist[3]= new Book ("ISBN1237","JAVA 마스터", 30000);
		booklist[3].setAuthor("송미영");
		booklist[3].setDescription("단계별로 프로젝트를 구현하며 배우는 JAVA 프로그래밍!");
		booklist[3].setCategory("IT전문서");
		booklist[3].setReleaseDate("2022/12/20");
		
		booklist[4]= new Book ("ISBN1238","완성된 웹사이트로 배우는 자바스크립트 ", 22000);
		booklist[4].setAuthor("mana");
		booklist[4].setDescription("하나의 웹사이트를 구현하며 익히는 자바스크립트 입문");
		booklist[4].setCategory("컴퓨터입문");
		booklist[4].setReleaseDate("2024/04/01");
	}
